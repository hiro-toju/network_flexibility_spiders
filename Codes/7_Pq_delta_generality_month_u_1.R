...
pdf('../Output/generality_dOS_eachmonth_u_Pq.pdf', w= 15, h= 7)
...
pdf('../Output/generality_dST_eachmonth_u_Pq.pdf', w= 15, h= 7)
...
pdf('../Output/generality_dOSpWN_eachmonth_u_Pq.pdf', w= 15, h= 7)
...
pdf('../Output/generality_dS_eachmonth_u_Pq.pdf', w= 15, h= 7)
...
pdf('../Output/generality_dWN_eachmonth_u_Pq.pdf', w= 15, h= 7)
