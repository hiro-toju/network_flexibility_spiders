...
write.table(beta_cons2, file="../Output/beta_cons_Pq.txt", quote=F, sep='\t', row.names=F)
...
ggsave(plot=ge, filename="../Output/transition_betadiversity_assembled_Pq.pdf", w=9, h=2)
...
ggsave(plot=ge, filename="../Output/transition_betadiversity_assembled_nolabel_Pq.pdf", w=6, h=2)
