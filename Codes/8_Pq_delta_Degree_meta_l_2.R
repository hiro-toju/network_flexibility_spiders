...
ge2 <- grid.arrange(g[[1]], g[[2]], g[[5]], g[[4]], nrow=2, ncol=2)

ggsave(plot=ge2, filename="../Output/delta_degree_meta_l_Pq_2.pdf", w=11, h=10.5)
...
r[1,1] <- cor.test(dOS_degree$degree_meta, dOS_degree$dOS_l_max, method="kendall")$estimate
r[2,1] <- cor.test(dST_degree$degree_meta, dST_degree$dST_l_max, method="kendall")$estimate
r[3,1] <- cor.test(dOSpWN_degree$degree_meta, dOSpWN_degree$dOSpWN_l_max, method="kendall")$estimate
r[4,1] <- cor.test(dS_degree$degree_meta, dS_degree$dS_l_max, method="kendall")$estimate
r[5,1] <- cor.test(dWN_degree$degree_meta, dWN_degree$dWN_l_max, method="kendall")$estimate
r[6,1] <- cor.test(d3$degree_meta, d3$dOS_dST, method="kendall")$estimate

r[1,2] <- cor.test(dOS_degree$degree_meta, dOS_degree$dOS_l_max, method="kendall")$p.value
r[2,2] <- cor.test(dST_degree$degree_meta, dST_degree$dST_l_max, method="kendall")$p.value
r[3,2] <- cor.test(dOSpWN_degree$degree_meta, dOSpWN_degree$dOSpWN_l_max, method="kendall")$p.value
r[4,2] <- cor.test(dS_degree$degree_meta, dS_degree$dS_l_max, method="kendall")$p.value
r[5,2] <- cor.test(dWN_degree$degree_meta, dWN_degree$dWN_l_max, method="kendall")$p.value
