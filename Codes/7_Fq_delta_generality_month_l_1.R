...
pdf('../Output/generality_dOS_eachmonth_l_Fq.pdf', w= 15, h= 7)
...
pdf('../Output/generality_dST_eachmonth_l_Fq.pdf', w= 15, h= 7)
...
pdf('../Output/generality_dOSpWN_eachmonth_l_Fq.pdf', w= 15, h= 7)
...
pdf('../Output/generality_dS_eachmonth_l_Fq.pdf', w= 15, h= 7)
...
pdf('../Output/generality_dWN_eachmonth_l_Fq.pdf', w= 15, h= 7)
