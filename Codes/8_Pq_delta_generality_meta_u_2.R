...
ggsave(plot=ge, filename="../Output/delta_generality_meta_u_Pq.pdf", w=18, h=11)
...
write.table(r2, file="../Output/correlation_delta_generality_u_Pq.txt", sep='\t', quote=F, row.names=F)
