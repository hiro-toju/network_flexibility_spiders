...
ggsave(plot=ge, filename="../Output/delta_Nsamples_u_Fq.pdf", w=18, h=11)
...
write.table(r2, file="../Output/correlation_delta_Nsamples_u_Fq.txt", sep='\t', quote=F, row.names=F)
