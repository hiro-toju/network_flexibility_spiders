...
ggsave(plot=ge, filename="../Output/delta_denerality_meta_l_Fq.pdf", w=18, h=11)
...
write.table(r2, file="../Output/correlation_delta_generality_l_Fq.txt", sep='\t', quote=F, row.names=F)
